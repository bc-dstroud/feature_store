...
spark.sql(f"""DROP TABLE if Exists bluecrew.default.work_history""")
...
write_spark_table_to_databricks_schema(optimize_spark(sdf), 'work_history2', 'bluecrew.default')
sdf = spark.read.format("delta").table('bluecrew.default.work_history2')
...
table_name = f"feature_store.dev.user_work_history2"
print(table_name)
